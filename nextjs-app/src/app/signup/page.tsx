...
export const metadata: Metadata = {
  title: 'Create Account | The Psilosopher',
  description: 'Create your Psilosopher account to access psychedelic education, integration tools, and member content.',
};
    ...
    <>
      ...
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <p className="text-gold-400 font-medium tracking-[0.3em] uppercase text-sm mb-6">Join the Community</p>
          <h1 className="font-serif text-5xl md:text-7xl font-bold text-white leading-[1.1] mb-6">
            Create Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-400 to-mystic-300">Account</span>
          </h1>
        </div>
      </section>
